...
<script>
    ...
    <div class="col-md-6 form-group cus-form-group">\n\
    <label for="image">Start Date</label>\n\
       <input type="date"  class="form-control datepicker_init ticketclass" name="ticket_start_date[' + x + ']"  aria-describedby="emailHelp" required placeholder="Start date"></div>\n\

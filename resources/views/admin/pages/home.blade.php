        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="trusted-brands mb-2">
                    <label for="trusted-brands" class=about_description"col-12">Trusted Brands</label>
                    <div class="row">
                        <label for="heading" class="col-12">Heading <span class='required_field required_red'>*</span></label>
...
required: true,
        ...
        featured_description: {about_description
                required: true,
        },
        about_heading: {
        required: true,
        ...
        required: "Featured heading is required",
                ...
                news_heading: {about_description
...
<script>
    ...
    CKEDITOR.replace('featured_description', {
      height:'20%',
      width: '100%'
    });
    ...
    CKEDITOR.replace('pricing_description', {
      height:'20%',
      width: '100%'
    });

...
@section("meta_page_title") Dashboard | states | States @endsection
@section("page_title") states @endsection
@section("css")
<style type="text/css">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h4 class="header-title">Manage states</h4>
                    </div>
                    <div class="col-6">


                        <a class="btn btn-bg" href="{{ route('admin.add.state') }}" style="color: black">Add state</a>

                    </div>
                </div>
                <p class="sub-header">View and manage account users on this page.</p>
                <table id="state-table" class="table table-hover m-0 table-centered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Country</th>
...
table_instance = $('#state-table').DataTable({
    "language": {
        "paginate": {
    ...
    'drawCallback': function (oSettings) {
        if (!initialized) {
            $('#state-table_filter.dataTables_filter').each(function () {
                initialized = true;
            });
        }
...
function deletestate(obj, id)
{

    Swal.fire({
        title: 'Delete state?',
        text: "Do you really want to delete this state and all data related to this state?",
        type: 'warning',

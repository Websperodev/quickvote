...
@section("meta_page_title") Admin | Quickvote | Our Team Banner @endsection
...
<div class="row justify-content-center">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title">Our Team Page Banner</h4>
                ...
                @endif
                 {!! Form::open(array('route' => 'admin.banner', 'id' => 'add_banner_form','class' => 'custum-frm', 'method' => 'post', 'enctype' => 'multipart/form-data' )) !!}
                    ...
                    <div class="top-banner mb-2">
                        ...
                        <input type="hidden" name="banner" value="our-team">
                        <div class="btn-right">

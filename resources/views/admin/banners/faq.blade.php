...
@section("meta_page_title") Admin | Quickvote | Faq Banner @endsection
...
<div class="row justify-content-center">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title">Faq Page Banner</h4>
                ...
                @endif
                 {!! Form::open(array('route' => 'admin.banner', 'id' => 'add_banner_form','class' => 'custum-frm', 'method' => 'post', 'enctype' => 'multipart/form-data' )) !!}
                    ...
                    <div class="top-banner mb-2">
                        ...
                        <div class="row">
                            <label for="heading" class="col-12">Heading 1</label>
                        ...
                        <input type="hidden" name="banner" value="faq">
                        <div class="btn-right">

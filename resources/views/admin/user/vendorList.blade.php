...
@section("meta_page_title") Dashboard | Vendors List | Vendors @endsection
@section("page_title") Vendors @endsection
@section("css")
<style type="text/css">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h4 class="header-title">Manage Vendors</h4>
                    </div>
                    <div class="col-6">


                        <a class="btn btn-bg" href="{{ route('admin.add.user') }}" style="color: black">Add New</a>

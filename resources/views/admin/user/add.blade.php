...
@section("page_title") <a class="head-a" href="{!! route('admin.users') !!}"> Users </a> > Add @endsection
                ...
                <div class="user-frm mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group cus-form-group">
                            ...
                            <input type="text"  class="form-control" value="{{ isset($userDescription->email) ? $user->email : ''}}" name="email" id="email" aria-describedby="emailHelp" placeholder="Enter Email">
                            @if($errors->has('email'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group cus-form-group">
                            ...
                            <input type="text" class="form-control" value="" name="postal" id="postal" aria-describedby="emailHelp" placeholder="Enter Postal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group cus-form-group">
                            ...
                            <input type="text" class="form-control" value="" name="twitter" id="twitter" aria-describedby="emailHelp" placeholder="Enter twitter profile">

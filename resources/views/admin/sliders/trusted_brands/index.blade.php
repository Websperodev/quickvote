    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
               <div class="row">
                <div class="col-6">
                    <h4 class="header-title">Manage Trusted Brands Slider Images</h4>
                </div>
                <div class="col-6">
                
                
                    <a class="btn btn-bg" href="{{ route('admin.add.trustedBrands') }}" style="color: black">Add Images</a>
                      
                </div>
               </div>
                <p class="sub-header">View and manage trusted brands slider on this page.</p>
                <table id="brands-slider-table" class="table table-hover m-0 table-centered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Image</th>
                            <th>Created</th>
...
@section("script-bottom")
    <script type="text/javascript">
        ...
        table_instance = $('#brands-slider-table').DataTable({
            "language": {
                "paginate": {
            ...
            'drawCallback': function (oSettings) {
                if (!initialized) {
                    $('#brands-slider-table_filter.dataTables_filter').each(function () {
                        initialized = true;
                    });
                }
            ...
            ajax: {
                url: "{{ route('admin.getTrustedBrandsSlider') }}",
                method: 'POST'
            },
            columnDefs: [
                {

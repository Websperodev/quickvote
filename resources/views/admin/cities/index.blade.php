...
@section("meta_page_title") Dashboard | Quickvote | Cities @endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h4 class="header-title">Manage Cities</h4>
                    </div>
                    <div class="col-6">


                        <a class="btn btn-bg" href="{{ route('admin.add.city') }}" style="color: black">Add city</a>

                    </div>
                </div>
                <p class="sub-header">View and manage account users on this page.</p>
                <table id="city-table" class="table table-hover m-0 table-centered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>State</th>                          
...
table_instance = $('#city-table').DataTable({
    "language": {
        "paginate": {
    ...
    'drawCallback': function (oSettings) {
        if (!initialized) {
            $('#city-table_filter.dataTables_filter').each(function () {
                initialized = true;
            });
        }
...
function deletecity(obj, id)
{
    ...
    Swal.fire({
        title: 'Delete city?',
        text: "Do you really want to delete this city and all data related to this city?",
        type: 'warning',

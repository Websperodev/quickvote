...
@section("meta_page_title") Dashboard | Our Team  @endsection
@section("page_title") Our Team @endsection
@section("css")
    <style type="text/css">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
               <div class="row">
                <div class="col-6">
                    <h4 class="header-title">Manage Our Team</h4>
                </div>
                <div class="col-6">
                    <a class="btn btn-bg" href="{{ route('our.investors') }}" style="color: black">Our Investors</a> 

                    <a class="btn btn-bg" href="{{ route('team.create') }}" style="color: black">Add Member</a>   
                
                    <a class="btn btn-bg" href="{{ route('team.addData') }}" style="color: black">Add Page Data</a>   
                </div>
               </div>
                <p class="sub-header">View and manage account users on this page.</p>
                <table id="team-table" class="table table-hover m-0 table-centered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Image</th>
                            <th>Name</th>
...
@section("script-bottom")
    <script type="text/javascript">
        ...
        table_instance = $('#team-table').DataTable({
            "language": {
                "paginate": {
            ...
            'drawCallback': function (oSettings) {
                if (!initialized) {
                    $('#team-table_filter.dataTables_filter').each(function () {
                        initialized = true;
                    });
                }

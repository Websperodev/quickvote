        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link {{ Nav::isRoute('/') }}" href="{{ url('/') }}">Home</a>
                    <a class="nav-link {{ Nav::isRoute('user.subcategories.index') }}"  href="{{ route('user.subcategories.index') }}">Votes </a>
                    <a class="nav-link {{ Nav::isRoute('about-us') }}" href="{{ route('about-us') }}">About Us</a>
                    <a class="nav-link {{ Nav::isRoute('our-services') }}" href="{{ route('our-services') }}">Services</a>
                    <a class="nav-link {{ Nav::isRoute('pricing') }}" href="{{ route('pricing') }}">Pricing</a>
                    <a class="nav-link {{ Nav::isRoute('faq') }}" href="{{ route('faq') }} ">FAQ</a>
                    <a class="nav-link {{ Nav::isRoute('contact') }}" href="{{ route('contact') }}">Contact</a>
                </div>
                <div class="reg-login">

                ...
                <div class="col-md-12 form-group cus-form-group">
                    ...
                    <div class="col-md-12 form-group cus-form-group ">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <input type="radio" checked class="votelimit" id='voteunlimit' name="limit" value="0">
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <label for="limit">Limited</label>
                            <input type="radio"  name="limit" id='votelimit' class="votelimit" value="1">
                        </div>
                        @if($errors->has('limit'))
                        ...
                        <div class="col-md-7 form-group cus-form-group votelimitcount">
                            ...
                            <input type="number" autocomplete="off" class="form-control" min="1" name="limit_count" id="organiser_name" value="" min ="0" aria-describedby="emailHelp" placeholder="Enter limit count">

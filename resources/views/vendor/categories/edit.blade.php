...
@section("meta_page_title") Vendor | Quickvote | Categories @endsection
@section("page_title") <a href="{!! route('vendor-categories.index') !!}" class="head-a"> Categories </a> > Edit @endsection
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(array('route' => ['vendor-categories.update', $subcategory->id ], 'id' => 'edit_category_form', 'method' => 'put','class' => 'custum-frm', 'enctype' => 'multipart/form-data' )) !!}
                @csrf

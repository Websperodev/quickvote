        ...
        <div class="card">
            <div class="card-body">
               <div class="row">
                ...
                <div class="col-6">
                    <a class="btn btn-bg" href="{{ route('event-categories.create') }}" style="color: black">Add Category</a>
                </div>
               </div>
...
@section("script-bottom")
    <script type="text/javascript">
        ...
        table_instance = $('#category-table').DataTable({
            ...
            ajax: {
                url: "{{ route('vendor.getAllCategories') }}",
                method: 'POST'
            },
            columnDefs: [
                {
    ...
    {
        var url = '{{ route("event-categories.destroy", ":id") }}';
        url = url.replace(':id', id);
       
        Swal.fire({
            title: 'Delete Category?',
            text: "Do you really want to delete this category and all data related to this Category?",
            type: 'warning',

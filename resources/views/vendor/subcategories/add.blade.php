...
@section("page_title") <a href="{!! route('subcategories.index') !!}" class="head-a"> Subcategories </a> > Add @endsection
...
<div class="row justify-content-center">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title">Subcategories</h4>
                ...
                {!! Form::open(array('route' => 'subcategories.store', 'id' => 'add_category_form', 'method' => 'post','class' => 'custum-frm', 'enctype' => 'multipart/form-data' )) !!}
                ...
                <div class="categories-frm mb-2">
                    ...
                    <div class="col-md-12 form-group cus-form-group">
                        <label for="name">Category Name <span class="required_field required_red">*</span></label>

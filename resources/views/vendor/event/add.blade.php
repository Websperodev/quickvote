...
//                            }
    ...
    <div class="col-md-6 form-group cus-form-group"><label for="image">End Date</label>\n\
         <input type="date" class="form-control ticket_end_date datepicker_init ticketclass" name="ticketend_date[' + x + ']" aria-describedby="emailHelp" required placeholder="End Date"></div>\n\
